<template>
  <div v-if="productLoading">Подождите, идёт загрузка страницы товара...</div>
  <div v-else-if="!productData">При загрузке страницы товара произошла ошибка.
      ...
      <div class="item__desc">
        ...
        <div class="item__content">
          ...
          <p>
            ...
            56 мм. На дисплей выводятся координаты и скорость, а также полученная со смартфона
            ...
            степень защиты от влаги IPX7. Это означает, что устройство не боится пыли,
            а также выдерживает кратковременное (до 30 минут) погружение в воду на глубину
            не более 1 метра.
          </p>
        </div>
      </div>
    ...
    loadProduct() {
      ...
      axios
        .get(`${API_BASE_URL}/api/products/${this.$route.params.id}`, {
          params: {
            id: this.productAmount,
          },
        })
        .then((response) => { this.productData = response.data; })
        .catch(() => { this.productData = null; })
